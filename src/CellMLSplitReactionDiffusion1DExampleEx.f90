...
! YOU CAN CHANGE THIS to change the diffusivity
  ...
  ! Set diff at specific element
    ElemMap = 12.0_CMISSDP
...
!Create CaFluo  reaction diffusion with constant source equations_set
...
!  & cmfe_FIELD_VALUES_SET_TYPE,1,10.0_CMISSDP,Err)
  ...
  CALL cmfe_CellML_ModelImport(CellML,"HinchSERCA.cellml",constantModelIndex,Err)
...
& ZeroDModelIndex,"fluo_buffer/Fluo",cmfe_FIELD_VALUES_SET_TYPE,Err)
CALL cmfe_CellML_CreateCellMLToFieldMap(CellML,ZeroDModelIndex,"fluo_buffer/Fluo",cmfe_FIELD_VALUES_SET_TYPE, &
...
& ZeroDModelIndex,"fluo_buffer/CaFluo",cmfe_FIELD_VALUES_SET_TYPE,Err)
CALL cmfe_CellML_CreateCellMLToFieldMap(CellML,ZeroDModelIndex,"fluo_buffer/CaFluo",cmfe_FIELD_VALUES_SET_TYPE, &
...
& ZeroDModelIndex,"nuc_Ca_buffer/B_nucm",cmfe_FIELD_VALUES_SET_TYPE,Err)
CALL cmfe_CellML_CreateCellMLToFieldMap(CellML,ZeroDModelIndex,"nuc_Ca_buffer/B_nucm",cmfe_FIELD_VALUES_SET_TYPE, &
...
& ZeroDModelIndex,"nuc_Ca_buffer/CaB_nucm",cmfe_FIELD_VALUES_SET_TYPE,Err)
CALL cmfe_CellML_CreateCellMLToFieldMap(CellML,ZeroDModelIndex,"nuc_Ca_buffer/CaB_nucm",cmfe_FIELD_VALUES_SET_TYPE, &
...
! YOU CAN CHANGE THIS - you can change the initial time, final time and time step for your RD sim.
  CALL cmfe_ControlLoop_TimesSet(ControlLoop,0.0_CMISSRP,100.0_CMISSRP,0.10_CMISSRP,Err)
!*******************************************************************************
...
!YOU CAN CHANGE THIS TO CHANGE THE POSITION OF THE NUCLEUS
  DO node=NUMBER_GLOBAL_X_ELEMENTS/2+1,NUMBER_GLOBAL_X_ELEMENTS+1
    NODE_NUMBER = BCNODES(node)
