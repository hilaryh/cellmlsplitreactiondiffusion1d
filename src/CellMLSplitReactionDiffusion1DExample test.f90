...
#include "mpif.h"
  ...
  TYPE(cmfe_FieldType) :: GeometricField,EquationsSetField,DependentField,MaterialsField,SourceField,CompartmentTypeField
...
CALL cmfe_Field_ComponentValuesInitialise(CompartmentTypeField,cmfe_FIELD_U_VARIABLE_TYPE, &
  ...
  !!! Added stuff
  CALL cmfe_CellML_VariableSetAsKnown(CellML,constantModelIndex,"dude/compartmentType",Err)
